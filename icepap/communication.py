...
class IcePAPCommunication:
    ...
    def send_cmd(self, cmd):
        ...
        ans = self._sock.write_read(cmd.encode(), 8096).decode()
    ...
    def send_binary(self, ushort_data):
        ...
        # Simpler alternative: to be tested:
        #checksum = sum(ushort_data) & 0xffffffff
        #header = struct.pack("<III", 0xa5aa555a, len(ushort_data), checksum)
        #payload = array.array('H', ushort_data).tostring()
        #str_bin = header + payload + b'\r'
